...
public class HomeController {
    ...
    public String showForm(Model model) {
        ...
        List<String> listExposures = Arrays.asList("One quarter (1/4)", "One half (1/2)", "Three quarters (3/4)", "Entire garden box");
        model.addAttribute("listExposures", listExposures);
